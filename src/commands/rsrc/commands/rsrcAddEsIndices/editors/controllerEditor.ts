import { buildControllerHandler } from '../../rsrcAddRoute/editors/routeHandlers'
import { AddRouteParams } from '../../rsrcAddRoute/TYPES'
...
export default function controllerEditor(rsrcName: string) {
  ...
  indicesExists${newController ? `,\n  ${newController}` : ''}
    ...
    const controllerParams: AddRouteParams = {
      rsrcName,
      partialName: '',
