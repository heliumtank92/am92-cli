...
import CRUD_MODEL_PARTIAL from '../helpers/fileTemplates/model/CRUD_MODEL_PARTIAL'
import CRUD_MODEL_INDEX from '../helpers/fileTemplates/model/CRUD_MODEL_INDEX'
import CRUD_CONTROLLER_PARTIAL from '../helpers/fileTemplates/controller/CRUD_CONTROLLER_PARTIAL'
import CRUD_CONTROLLER_INDEX from '../helpers/fileTemplates/controller/CRUD_CONTROLLER_INDEX'
import CRUD_ROUTER_PARTIAL from '../helpers/fileTemplates/router/CRUD_ROUTER_PARTIAL'
import CRUD_ROUTER_INDEX from '../helpers/fileTemplates/router/CRUD_ROUTER_INDEX'
...
const COMMAND = 'rsrc-create-es-crud-folder-struct'

yargs.command(
  COMMAND,
  colorify.trace('Create Backend Resource with OpensearchOdm CRUD in Folders'),
  createBuilder,
  handler
)
