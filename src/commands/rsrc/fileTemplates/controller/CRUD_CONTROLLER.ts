const CRUD_CONTROLLER = `import { ResponseBody } from '@am92/express-utils'
...
async function create(request, response, next) {
  ...
  const responseBody = new ResponseBody(201, '{rsrcName} Create Successful', data)
...
export default CRUD_CONTROLLER
